...
# phone
$(call inherit-product, vendor/Droid_Concept/config/common_phone.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=Droid_Concepts.maguro.$(shell date +%m%d%y).$(shell date +%H%M%S)
